...
func (t *TemplateGenerator) getSingleLineForTemplate(textFilename string, vm *api.APIModel, profile interface{}) (string, error) {
	...
	templ := template.New("customdata template").Funcs(t.getTemplateFuncMap(vm))
